...
const CartPartBe = ({keystring, cardData}:
    ...
    const h = 200;
    return (
    <Card key={keystring} hoverable style={{'width':w,'height':h}} >
        <Row >
            <Col>
            ...
            <Col style = {{width:`${3/5*100}%`,display:'flex','flex-flow':'column wrap'}}>
                <Meta title={cardData.lpcorp}/>
                <Meta description={cardData.fn}/>
                <Meta title={cardData.an}/>
            </Col>
...
const P2CompCardGroup = ({data, refFunc}:
...
export default P2CompCardGroup
