...
export const FundColumns: ColumnsType<FundDataType> = [
    ...
    { title: 'LOAN 총액', dataIndex: 'loan', key: 'loan', width: 200 },
    { title: '대출약정금', dataIndex: 'loanamt', key: 'loanamt', width: 200 },
    ...
    { title: '체결일이자율', dataIndex: 'sdaterate', key: 'sdaterate', width: 120 },

    { title: '토지주소', dataIndex: 'addr', key: 'addr', width: 150, ellipsis: true },
    { title: '설정일', dataIndex: 'sdate', key: 'sdate', width: 120 },
    { title: '만기일', dataIndex: 'mdate', key: 'mdate', width: 120 },
    ...
    { title: 'EQUITY 총액', dataIndex: 'equity', key: 'equity', width: 200 },

    { title: 'AUM 총액', dataIndex: 'aum', key: 'aum', width: 200 },
    { title: 'LTV', dataIndex: 'ltv', key: 'ltv', width: 120 },
    { title: '롤오버', dataIndex: 'ro', key: 'ro', width: 100 },
    { title: '대출계약체결일', dataIndex: 'loandate', key: 'loandate', width: 130 },
    { title: '대주수', dataIndex: 'lpnum', key: 'lpnum', width: 70 },
